//! Text inputs using Moonveil's concrete theme and resolved field tokens.

use crate::{Theme, widget::field};

pub use iced_core::widget::Id;
pub use iced_widget::text_input::{Catalog, Status, Style};

/// A custom text input style function using Moonveil's concrete theme.
...
/// A built-in Moonveil text input style.
...
/// Returns the resolved style for a built-in text input variant and status.
